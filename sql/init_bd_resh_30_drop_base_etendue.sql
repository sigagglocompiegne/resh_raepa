...
-- #an_raepa_canalae
ALTER TABLE IF EXISTS m_raepa.an_raepa_canalae DROP CONSTRAINT IF EXISTS lt_raepa_contcanaep_fkey;
...
-- #an_raepa_ouvae
ALTER TABLE IF EXISTS m_raepa.an_raepa_appae DROP CONSTRAINT IF EXISTS lt_raepa_fnappaep_fkey;
