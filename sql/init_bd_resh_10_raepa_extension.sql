...
ALTER TABLE raepa.canalisation_ae RENAME CONSTRAINT val_raepa_cat_canal_ae_fkey TO lt_raepa_contcanaep_fkey;
...
ALTER TABLE raepa.appareillage_ae RENAME CONSTRAINT val_raepa_fonc_app_ae_fkey TO lt_raepa_fnappaep_fkey;
...
ALTER TABLE IF EXISTS raepa.val_raepa_cat_canal_ae RENAME TO lt_raepa_contcanaep;
ALTER TABLE IF EXISTS raepa.val_raepa_fonc_canal_ae RENAME TO lt_raepa_fonccanaep;
ALTER TABLE IF EXISTS raepa.val_raepa_fonc_app_ae RENAME TO lt_raepa_fnappaep;
...
COMMENT ON COLUMN m_raepa.lt_raepal_sensecoul.code IS 'Code de la liste énumérée relative au sens d''écoulement de la canalisation.';
...
INSERT INTO m_raepa.lt_raepal_sensecoul(code,
            valeur, definition)
    VALUES
('0','Indéterminée','Sens d''écoulement inconnu'),
('d','Direct','L''écoulement s''effectue du noeud initial vers le noeud terminal'),
('i','Inverse','L''écoulement s''effectue du noeud terminal vers le noeud initial');
...
('04-00','04','Déversoir d''orage','Déversoir d''orage'),
('05-00','05','Rejet','Rejet (exutoire) dans le milieu naturel d''eaux usées ou pluviales'),
('06-00','99','Chambre','Chambre'),
('06-01','06','Chambre de comptage','Chambre de comptage'), -- conservé car présent dans le raepa, mais devrait être dans une classe spécialisée
...
('10','Privé','Objet appartenant au domaine privé'),
('20','Public','Objet appartenant au domaine public'),
('99','Autre','Objet appartenant à un domaine ne figurant pas dans la liste ci-dessus');
...
('02','Moyen','Objet en état moyen'),
('03','Mauvais','Objet en mauvais état'),
...
('03','Dallot','Canalisation de forme dallot'),
...
('01','Boîte de raccordement à passage direct','Boîte de raccordement à passage direct'),
('02','Boîte de raccordement à passage siphoïde','Boîte de raccordement à passage siphoïde'),
('03','Boîte de raccordement multidirectionnel','Boîte de raccordement multidirectionnel'),
...
-- Table: m_raepa.lt_raepal_positvid

-- DROP TABLE m_raepa.lt_raepal_positvid;


CREATE TABLE m_raepa.lt_raepal_positvid
(
  code character varying(2) NOT NULL, -- code de la liste
  valeur character varying(80) NOT NULL, -- valeur de la liste
  definition character varying(255), --définition
...
COMMENT ON TABLE m_raepa.lt_raepal_positvid
  IS 'Liste décrivant la position de l''appareillage de vidange d''Adduction d''eau potable';
COMMENT ON COLUMN m_raepa.lt_raepal_positvid.code IS 'Code interne de la liste énumérée relative à la position de l''appareillage de vidange d''Adduction d''eau potable';
COMMENT ON COLUMN m_raepa.lt_raepal_positvid.valeur IS 'Valeur de la liste énumérée relative à la position de l''appareillage de vidange d''Adduction d''eau potable';
COMMENT ON COLUMN m_raepa.lt_raepal_positvid.definition IS 'Définition de la liste énumérée relative à la position de l''appareillage de vidange d''Adduction d''eau potable';

INSERT INTO m_raepa.lt_raepal_positvid(code,
            valeur, definition)
    VALUES
('00','Indéterminé','Position de vidange inconnue'),
('01','En regard','Vidange situé en regard'),
('02','Sous bouche à clé','Vidange situé sous bouche à clé'),
('99','Autre','Autre position de la vidange ne figurant pas dans la liste ci-dessus');
...
ALTER TABLE m_raepa.an_raepal_objet_reseau
	...
	ADD COLUMN materiau character varying (5), -- Matériau de l'objet de réseau. Issu du RAEPA déplacé pour tout objets de réseau
	...
	ADD COLUMN l_libvoie character varying (2) NOT NULL, -- Adressafe du nom de la rue où est positionné l'objet. Généré lors de l'intégration FME
...
(
  ...
  l_etatvan character varying (2) NOT NULL DEFAULT '00', -- Postion de la vanne (Ouverte ou Fermée)
...
COMMENT ON COLUMN m_raepa.an_raepal_vanne_ae.l_etatvan IS 'Postion de la vanne (Ouverte ou Fermée)';
...
(
  ...
  l_dimgrill character varying (20), -- Dimension de la grille, en cm.  
...
COMMENT ON COLUMN m_raepa.an_raepal_regard_ass.l_dimgrill IS '  Dimension de la grille, en cm.';
...
COMMENT ON COLUMN m_raepa.an_raepal_avaloir_ass.l_dimgrill IS 'Dimension de la grille, en cm.';
...
(
  ...
  reseau character varying (7) NOT NULL, -- Réseau concerné
  typcomp character varying (20) NOT NULL, -- Type de comparaison
  typeobjet character varying (20) NOT NULL, --Type d'objet du réseau
  concess character varying (20) NOT NULL, -- Définit le concessionnaire de l'objet
  date_liv date NOT NULL, -- date de livraison du jeu de données
...
COMMENT ON COLUMN m_raepa.geo_raepal_comparateur.reseau IS 'Réseau de l''objet';
COMMENT ON COLUMN m_raepa.geo_raepal_comparateur.typcomp IS 'Type de comparaison (Ajout/Suppression)';

COMMENT ON COLUMN m_raepa.geo_raepal_comparateur.typeobjet IS 'Type de l''objet';
COMMENT ON COLUMN m_raepa.geo_raepal_comparateur.date_liv IS 'Date de livraison du jeu de données';
...
ALTER TABLE m_raepa.an_raepal_vidange_ae
  ...
  ADD CONSTRAINT lt_raepal_positvid_fkey FOREIGN KEY (l_positvid)
      REFERENCES m_raepa.lt_raepal_positvid (code) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
-- View: x_opendata.x_opendata_raepa_canalaep_l

-- DROP MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalaep_l;
CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalaep_l AS 
 SELECT 
  e.idobjet as "IDCANA",
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalaep_l
  IS 'Canalisation d''adduction d''eau';


-- #################################################################### VUE CANALISATION ASS ###############################################

-- View: x_opendata.x_opendata_raepa_canalass_l

-- DROP MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalass_l;

CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalass_l AS 
 SELECT 
  a.idobjet as "IDCANA",
  o.mouvrage as "MOUVRAGE",
  o.gexploit as "GEXPLOIT", 
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_canalass_l
...
-- View: x_opendata.x_opendata_raepa_apparaep_p

-- DROP MATERIALIZED VIEW x_opendata.x_opendata_raepa_apparaep_p;

CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_apparaep_p AS 
 SELECT
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_apparaep_p
...
-- View: x_opendata.x_opendata_raepa_apparass_p

-- DROP VIEW x_opendata.x_opendata_raepa_apparass_p;

CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_apparass_p AS 
 SELECT
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_apparass_p
...
-- View: x_opendata.x_opendata_raepa_ouvraep_papp

-- DROP MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvraep_p;

CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvraep_p AS 
 SELECT
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvraep_p
  IS 'Ouvrage d''adduction d''eau';


-- #################################################################### VUE OUVRAGE ASS ###############################################

-- View: x_opendata.x_opendata_raepa_ouvrass_p

-- DROP MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvrass_p;

CREATE MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvrass_p AS 
 SELECT
...
COMMENT ON MATERIALIZED VIEW x_opendata.x_opendata_raepa_ouvrass_p
